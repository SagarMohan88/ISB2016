---
title: "Discriminant and Factor Analysis"
date: "`r Sys.Date()`"
...
# Generalizing the number of groups
...
rates = read.table("data_files/tryrates.txt",header=TRUE)
print(names(rates))
print(head(rates))
```
...
<img src="image_files/LDAvsPCA.png" height=400 width=700>
...
tryrates = read.table("data_files/tryrates.txt",header=TRUE)
...
<img src="image_files/FactorRotation.png" height=540 width=740>
